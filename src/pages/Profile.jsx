...
const Profile = () => {
  ...
  const getUserData = async () => {
    try {
      const response = await axios(`https://shop-cart-api.vercel.app/user/${id}`);
  ...
  const updateProfile = async (e) => {
    ...
    try{
      ...
      const getResponse = await axios(`https://shop-cart-api.vercel.app/user/${id}`);
      const userObj = getResponse.data;

      // saljemo get(default) request
      const putResponse = await axios.put(`https://shop-cart-api.vercel.app/user/${id}`, {
        id: id,
